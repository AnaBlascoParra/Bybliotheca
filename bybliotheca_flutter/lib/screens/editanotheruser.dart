...
class EditAnotherUserScreen extends StatefulWidget {
  final String username;
  EditAnotherUserScreen({required this.username});
  @override
  _EditAnotherUserScreenState createState() => _EditAnotherUserScreenState();
}

class _EditAnotherUserScreenState extends State<EditAnotherUserScreen> {
  ...
  void initState() {
    super.initState();
    _user = getUserByUsername(widget.username);
  }
